...
export function normaliseHouseRecord(record = {}) {
  ...
  return {
    ...
    mortgage: {
      ...
      remainingTermMonths: safeNumber(mortgage.remainingTermMonths ?? house.mortgageRemainingTermMonths, 0),
      ...
      repaymentType: mortgage.repaymentType || house.mortgageRepaymentType || "repayment",
      fixedEndDate: mortgage.fixedEndDate || house.mortgageFixedEndDate || null,
      followOnRate: safeNumber(mortgage.followOnRate ?? house.mortgageFollowOnRate, 0),
      monthlyPayment: safeNumber(mortgage.monthlyPayment ?? house.mortgageMonthlyPayment, 0),
      paymentDay: safeNumber(mortgage.paymentDay ?? house.mortgagePaymentDay, 1),
      plannedMonthlyOverpayment: safeNumber(mortgage.plannedMonthlyOverpayment ?? house.mortgagePlannedMonthlyOverpayment, 0),
      overpaymentAllowancePercent: safeNumber(mortgage.overpaymentAllowancePercent ?? house.mortgageOverpaymentAllowancePercent, 10),
      earlyRepaymentChargeApplies: Boolean(mortgage.earlyRepaymentChargeApplies ?? house.mortgageEarlyRepaymentChargeApplies),
      linkedAccountId: mortgage.linkedAccountId || house.linkedAccountId || null,
      notes: mortgage.notes || house.mortgageNotes || ""
    },
...
export function createHouseFromMortgageLoan(loan = {}) {
  ...
  return normaliseHouseRecord({
    ...
    mortgage: {
      ...
      remainingTermMonths: details.remainingTermMonths || 0,
      interestRate: details.currentRate || 0,
      rateType: details.interestType || "fixed",
      repaymentType: details.repaymentType || "repayment",
      fixedEndDate: details.fixedUntil || null,
      followOnRate: details.followOnRate || 0,
      monthlyPayment: details.monthlyPayment || 0,
      paymentDay: details.paymentDay || 1,
      plannedMonthlyOverpayment: details.plannedMonthlyOverpayment || 0,
      overpaymentAllowancePercent: details.overpaymentAllowancePercent ?? 10,
      earlyRepaymentChargeApplies: Boolean(details.earlyRepaymentChargeApplies),
